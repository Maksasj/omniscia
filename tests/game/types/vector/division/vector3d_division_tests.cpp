...
int main() {
    ...
    TEST_CASE {
        ...
        ensure(c.to_string() == "0.333333 0.333333 0.333333");
    }
    ...
    TEST_CASE {
        ...
        ensure(c.to_string() == "4 4 4");
    }

    TEST_CASE {
        Vec3f a = Vec3f{641856.2981f, 471899.91922f, 471899.91922f};
        
        auto c = a / 9158.11266f;

        ensure(c.to_string() == "70.0861 51.5281 51.5281");
    }
