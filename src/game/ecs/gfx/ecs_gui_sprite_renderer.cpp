...
omniscia::core::ecs::ECS_GuiSpriteRenderer::ECS_GuiSpriteRenderer(const std::string& textureId, const u32& layer) : _sprite(textureId), ECS_ProRenderer(RenderStagePool::get_instance().get_stage_by_name("GuiStage"), layer) {
    ECS_ProRendererSystem::get_instance().bind_component(this);
};

void omniscia::core::ecs::ECS_GuiSpriteRenderer::time_sync() {
    ECS_ProRendererSystem::get_instance().bind_component(this);
}

void omniscia::core::ecs::ECS_GuiSpriteRenderer::reindex(void* parent) {
...
void omniscia::core::ecs::ECS_GuiSpriteRenderer::set_texture_by_id(const std::string& textureId) {
